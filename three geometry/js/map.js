...
function cutovereventgroupfunc() {
    ...
    function main(result) {
        ...
        var geometry = new THREE.CylinderGeometry(1, 20, 20, 3);
        var material = new THREE.MeshBasicMaterial({ color: '#3BDCF6' });//0x3BDCF6
        var cone = new THREE.Mesh(geometry, material);
        cone.position.set(0, 40, 0)
        scene.add(cone);
        //指标2
        var geometry1 = new THREE.CylinderGeometry(20, 40, 20, 3);
        ...
        scene.add(cylinder1);
        //指标3
        var geometry2 = new THREE.CylinderGeometry(40, 60, 20, 3);
        ...
        //文字
        var textdata = [
            { "text": result[0]['vendorname'] + ':' + result[0]['num'], "num": result[0]['num'], 'pos': [2, 40, 10] },
            { "text": result[1]['vendorname'] + ':' + result[1]['num'], "num": result[1]['num'], 'pos': [13, 20, 15] },
            { "text": result[2]['vendorname'] + ':' + result[2]['num'], "num": result[2]['num'], 'pos': [26, 0, 10] }
        ]
